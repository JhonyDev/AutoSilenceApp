package app.autosilenceapp.Mosque;
...
public class findMosque extends AppCompatActivity implements LocationListener {
        ...
        if (googleMap == null) {
            ...
            mapFragment.getMapAsync(new OnMapReadyCallback() {
                ...
                public void onMapReady(GoogleMap googleMap) {
                    ...
                    findMosque.this.googleMap = googleMap;
                    //ok - proceed
                    googleMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
                    //create marker array
                    markers = new Marker[MAX_PLACES];
    ...
    private void updatePlaces(Location lastLoc) {
        ...
        {
            locMan= (LocationManager) findMosque.this.getSystemService(LOCATION_SERVICE);
            ...
            else
            {
                ...
                Toast.makeText(findMosque.this, "Location could not be found, please enable location and allow app to use location and internet.", Toast.LENGTH_LONG).show();
                findMosque.this.finish();
            }
        }
        ...
        if(lastLoc !=null ) {
            ...
            String placesSearchStr = "https://maps.googleapis.com/maps/api/place/nearbysearch/" +
                    ...
                    "&types=mosque" +
                    "&key=AIzaSyAND1J92IKgOKuFAetkuJrwKj2T4-v9EYQ";//ADD KEY
            ...
            if(isNetworkAvailable()) {
                ...
                Toast.makeText(findMosque.this,"No internet access, app will not work properly",Toast.LENGTH_LONG).show();
            }
        }
        else
        {
            ...
            try {
                ...
                for (int p = 0; p < placesArray.length(); p++) {
                    ...
                    try {
                        ...
                        Toast.makeText(findMosque.this,"Could not fetch data from server", Toast.LENGTH_LONG).show();
                        missingValue = true;
                        jse.printStackTrace();
                    }
    ...
    public class WifiReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (netInfo != null && netInfo.getType() == ConnectivityManager.TYPE_WIFI)
                ...
                if(googleMap==null && markers==null)
                    Toast.makeText(findMosque.this,"Please enable internet, or the app will not work properly.", Toast.LENGTH_LONG).show();
        }
    }
